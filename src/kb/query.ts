...
const HAS_TOPIC = /vpn|netbird|2sv|2-step|google workspace|dokploy|claude|kiro|outline|mcp|obsidian|wsl|docker|grab|เครื่องพิมพ์|พิมพ์ซอง|เน็ตเวิร์ก|ไวไฟ|timesheet|humansoft|pojjaman|builk\s*360|kwanjai|ขวัญใจ|\berp\b|วันลา|ลาป่วย|ลากิจ|พักร้อน|วันหยุด|กองทุน|ค่าน้ำมัน|ค่าเดินทาง|กีฬาสี|ห้องประชุม|ภาษี|ที่อยู่|เบอร์|ติดต่อ|plo[y]|พลอย|jubili|insite/i;
